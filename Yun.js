...
function kkk(i1x) {
    var bYl4p = d(JSON.stringify(i1x), bkZ3x(["流泪", "强"]), bkZ3x(VK8C.md), bkZ3x(["爱心", "女孩", "惊恐", "大笑"]));
    return bYl4p
}
    var HI3x = function(i1x, u1x) {
        try {
            u1x = u1x.toLowerCase();
            if (i1x === null)
                return u1x == "null";
    ...
    var k1xgQ5V = function(i1x) {
        return HI3x(i1x, "function")
    };
var k1x = function(j1x, cE3x, O1x) {
        if (!j1x || !j1x.length || !k1xgQ5V(cE3x))
            return this;
        if (!!j1x.forEach) {
            j1x.forEach(cE3x, O1x);
            return this
        }
        for (var i = 0, l = j1x.length; i < l; i++)
            cE3x.call(O1x, j1x[i], i, j1x);
        return this
    };
    var bkZ3x = function(cHw2x) {
        var m1x = [];
        k1x(cHw2x, function(cHv2x) {
            m1x.push(VK8C.emj[cHv2x])
        });
        return m1x.join("")
    };
